...
class QueryPaymentsResponse(_message.Message):
    ...
    PAGINATION_FIELD_NUMBER: _ClassVar[int]
    payments: _containers.RepeatedCompositeFieldContainer[_types_pb2.Payment]
    pagination: _pagination_pb2.PageResponse

    def __init__(self, payments: _Optional[_Iterable[_Union[_types_pb2.Payment, _Mapping]]]=..., pagination: _Optional[_Union[_pagination_pb2.PageResponse, _Mapping]]=...) -> None:
        ...