...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _QUERY.methods_by_name['Providers']._serialized_options = b'\x82\xd3\xe4\x93\x02#\x12!/akash/provider/v1beta3/providers'
    _QUERY.methods_by_name['Provider']._options = None
    _QUERY.methods_by_name['Provider']._serialized_options = b'\x82\xd3\xe4\x93\x02+\x12)/akash/provider/v1beta3/providers/{owner}'
