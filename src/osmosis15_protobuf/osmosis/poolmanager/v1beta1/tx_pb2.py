...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _globals['_MSGSWAPEXACTAMOUNTIN']._serialized_end = 476
    _globals['_MSGSWAPEXACTAMOUNTINRESPONSE']._serialized_start = 479
    _globals['_MSGSWAPEXACTAMOUNTINRESPONSE']._serialized_end = 610
    _globals['_MSGSWAPEXACTAMOUNTOUT']._serialized_start = 613
    _globals['_MSGSWAPEXACTAMOUNTOUT']._serialized_end = 921
    _globals['_MSGSWAPEXACTAMOUNTOUTRESPONSE']._serialized_start = 924
    _globals['_MSGSWAPEXACTAMOUNTOUTRESPONSE']._serialized_end = 1054
    _globals['_MSG']._serialized_start = 1057
