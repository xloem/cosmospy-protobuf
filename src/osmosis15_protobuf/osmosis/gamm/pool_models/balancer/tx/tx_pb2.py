...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _globals['_MSGCREATEBALANCERPOOL']._serialized_start = 200
    _globals['_MSGCREATEBALANCERPOOL']._serialized_end = 460
    _globals['_MSGCREATEBALANCERPOOLRESPONSE']._serialized_start = 462
    _globals['_MSGCREATEBALANCERPOOLRESPONSE']._serialized_end = 522
    _globals['_MSG']._serialized_start = 525
    _globals['_MSG']._serialized_end = 691