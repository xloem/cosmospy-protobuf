...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _globals['_POOLPARAMS']._serialized_end = 466
    _globals['_POOL']._serialized_start = 469
    _globals['_POOL']._serialized_end = 1038