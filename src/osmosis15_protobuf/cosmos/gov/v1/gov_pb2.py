...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _TALLYPARAMS.fields_by_name['quorum']._serialized_options = b'\xea\xde\x1f\x10quorum,omitempty\xd2\xb4-\ncosmos.Dec'
    _TALLYPARAMS.fields_by_name['threshold']._options = None
    _TALLYPARAMS.fields_by_name['threshold']._serialized_options = b'\xea\xde\x1f\x13threshold,omitempty\xd2\xb4-\ncosmos.Dec'
    _TALLYPARAMS.fields_by_name['veto_threshold']._options = None
    _TALLYPARAMS.fields_by_name['veto_threshold']._serialized_options = b'\xea\xde\x1f\x18veto_threshold,omitempty\xd2\xb4-\ncosmos.Dec'
