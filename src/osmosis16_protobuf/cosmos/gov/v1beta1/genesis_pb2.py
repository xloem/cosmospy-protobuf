...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _GENESISSTATE.fields_by_name['deposits']._serialized_options = b'\xc8\xde\x1f\x00\xaa\xdf\x1f\x08Deposits\xa8\xe7\xb0*\x01'
    _GENESISSTATE.fields_by_name['votes']._options = None
    _GENESISSTATE.fields_by_name['votes']._serialized_options = b'\xc8\xde\x1f\x00\xaa\xdf\x1f\x05Votes\xa8\xe7\xb0*\x01'
    _GENESISSTATE.fields_by_name['proposals']._options = None
    _GENESISSTATE.fields_by_name['proposals']._serialized_options = b'\xc8\xde\x1f\x00\xaa\xdf\x1f\tProposals\xa8\xe7\xb0*\x01'
    _GENESISSTATE.fields_by_name['deposit_params']._options = None
    _GENESISSTATE.fields_by_name['deposit_params']._serialized_options = b'\xc8\xde\x1f\x00\xa8\xe7\xb0*\x01'
    _GENESISSTATE.fields_by_name['voting_params']._options = None
    _GENESISSTATE.fields_by_name['voting_params']._serialized_options = b'\xc8\xde\x1f\x00\xa8\xe7\xb0*\x01'
    _GENESISSTATE.fields_by_name['tally_params']._options = None
    _GENESISSTATE.fields_by_name['tally_params']._serialized_options = b'\xc8\xde\x1f\x00\xa8\xe7\xb0*\x01'
