...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _GENESISSTATE.fields_by_name['gen_txs']._serialized_options = b'\xea\xde\x1f\x06gentxs\xfa\xde\x1f\x18encoding/json.RawMessage\xa2\xe7\xb0*\x06gentxs\xa8\xe7\xb0*\x01'
