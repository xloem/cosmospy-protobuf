...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _QUERYEVIDENCEREQUEST.fields_by_name['evidence_hash']._serialized_options = b'\x18\x01\xfa\xde\x1f0github.com/cometbft/cometbft/libs/bytes.HexBytes'
    _QUERY.methods_by_name['Evidence']._options = None
    _QUERY.methods_by_name['Evidence']._serialized_options = b'\x82\xd3\xe4\x93\x02*\x12(/cosmos/evidence/v1beta1/evidence/{hash}'
