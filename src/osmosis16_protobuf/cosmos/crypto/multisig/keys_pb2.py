...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _LEGACYAMINOPUBKEY.fields_by_name['public_keys']._serialized_options = b'\xe2\xde\x1f\x07PubKeys\xa2\xe7\xb0*\x07pubkeys'
    _LEGACYAMINOPUBKEY._options = None
    _LEGACYAMINOPUBKEY._serialized_options = b'\x88\xa0\x1f\x00\x8a\xe7\xb0*"tendermint/PubKeyMultisigThreshold\x92\xe7\xb0*\x10threshold_string'
