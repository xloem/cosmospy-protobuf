...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _BLOCK.fields_by_name['header']._serialized_options = b'\xc8\xde\x1f\x00\xa8\xe7\xb0*\x01'
    _BLOCK.fields_by_name['data']._options = None
    _BLOCK.fields_by_name['data']._serialized_options = b'\xc8\xde\x1f\x00\xa8\xe7\xb0*\x01'
    _BLOCK.fields_by_name['evidence']._options = None
    _BLOCK.fields_by_name['evidence']._serialized_options = b'\xc8\xde\x1f\x00\xa8\xe7\xb0*\x01'
    _HEADER.fields_by_name['version']._options = None
    _HEADER.fields_by_name['version']._serialized_options = b'\xc8\xde\x1f\x00\xa8\xe7\xb0*\x01'
    ...
    _HEADER.fields_by_name['time']._serialized_options = b'\xc8\xde\x1f\x00\x90\xdf\x1f\x01\xa8\xe7\xb0*\x01'
    _HEADER.fields_by_name['last_block_id']._options = None
    _HEADER.fields_by_name['last_block_id']._serialized_options = b'\xc8\xde\x1f\x00\xa8\xe7\xb0*\x01'
