...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _GENERICAUTHORIZATION._serialized_options = b'\xca\xb4-"cosmos.authz.v1beta1.Authorization\x8a\xe7\xb0*\x1fcosmos-sdk/GenericAuthorization'
    _GRANT.fields_by_name['authorization']._options = None
    _GRANT.fields_by_name['authorization']._serialized_options = b'\xca\xb4-"cosmos.authz.v1beta1.Authorization'
    _GRANT.fields_by_name['expiration']._options = None
    _GRANT.fields_by_name['expiration']._serialized_options = b'\xc8\xde\x1f\x01\x90\xdf\x1f\x01'
    ...
    _GRANTAUTHORIZATION.fields_by_name['authorization']._serialized_options = b'\xca\xb4-"cosmos.authz.v1beta1.Authorization'
