...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _QUERYSIGNINGINFORESPONSE.fields_by_name['val_signing_info']._serialized_options = b'\xc8\xde\x1f\x00\xa8\xe7\xb0*\x01'
    _QUERYSIGNINGINFOSRESPONSE.fields_by_name['info']._options = None
    _QUERYSIGNINGINFOSRESPONSE.fields_by_name['info']._serialized_options = b'\xc8\xde\x1f\x00\xa8\xe7\xb0*\x01'
