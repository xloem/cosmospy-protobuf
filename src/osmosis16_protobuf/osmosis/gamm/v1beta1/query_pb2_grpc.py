...
class QueryStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ConcentratedPoolIdLinkFromCFMM = channel.unary_unary('/osmosis.gamm.v1beta1.Query/ConcentratedPoolIdLinkFromCFMM', request_serializer=osmosis_dot_gamm_dot_v1beta1_dot_query__pb2.QueryConcentratedPoolIdLinkFromCFMMRequest.SerializeToString, response_deserializer=osmosis_dot_gamm_dot_v1beta1_dot_query__pb2.QueryConcentratedPoolIdLinkFromCFMMResponse.FromString)
...
class Query(object):
    ...
    @staticmethod
    def ConcentratedPoolIdLinkFromCFMM(request, target, options=(), channel_credentials=None, call_credentials=None, insecure=False, compression=None, wait_for_ready=None, timeout=None, metadata=None):
        return grpc.experimental.unary_unary(request, target, '/osmosis.gamm.v1beta1.Query/ConcentratedPoolIdLinkFromCFMM', osmosis_dot_gamm_dot_v1beta1_dot_query__pb2.QueryConcentratedPoolIdLinkFromCFMMRequest.SerializeToString, osmosis_dot_gamm_dot_v1beta1_dot_query__pb2.QueryConcentratedPoolIdLinkFromCFMMResponse.FromString, options, channel_credentials, insecure, call_credentials, compression, wait_for_ready, timeout, metadata)