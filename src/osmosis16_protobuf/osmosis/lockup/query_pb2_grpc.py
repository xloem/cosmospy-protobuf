...
class QueryStub(object):
    ...
    def __init__(self, channel):
        ...
        self.LockRewardReceiver = channel.unary_unary('/osmosis.lockup.Query/LockRewardReceiver', request_serializer=osmosis_dot_lockup_dot_query__pb2.LockRewardReceiverRequest.SerializeToString, response_deserializer=osmosis_dot_lockup_dot_query__pb2.LockRewardReceiverResponse.FromString)
        self.NextLockID = channel.unary_unary('/osmosis.lockup.Query/NextLockID', request_serializer=osmosis_dot_lockup_dot_query__pb2.NextLockIDRequest.SerializeToString, response_deserializer=osmosis_dot_lockup_dot_query__pb2.NextLockIDResponse.FromString)
        ...
        self.SyntheticLockupByLockupID = channel.unary_unary('/osmosis.lockup.Query/SyntheticLockupByLockupID', request_serializer=osmosis_dot_lockup_dot_query__pb2.SyntheticLockupByLockupIDRequest.SerializeToString, response_deserializer=osmosis_dot_lockup_dot_query__pb2.SyntheticLockupByLockupIDResponse.FromString)
        ...
        self.Params = channel.unary_unary('/osmosis.lockup.Query/Params', request_serializer=osmosis_dot_lockup_dot_query__pb2.QueryParamsRequest.SerializeToString, response_deserializer=osmosis_dot_lockup_dot_query__pb2.QueryParamsResponse.FromString)
...
class QueryServicer(object):
    ...
    def LockRewardReceiver(self, request, context):
        """Returns lock record by id
        """
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
...
class Query(object):
    ...
    @staticmethod
    def LockRewardReceiver(request, target, options=(), channel_credentials=None, call_credentials=None, insecure=False, compression=None, wait_for_ready=None, timeout=None, metadata=None):
        return grpc.experimental.unary_unary(request, target, '/osmosis.lockup.Query/LockRewardReceiver', osmosis_dot_lockup_dot_query__pb2.LockRewardReceiverRequest.SerializeToString, osmosis_dot_lockup_dot_query__pb2.LockRewardReceiverResponse.FromString, options, channel_credentials, insecure, call_credentials, compression, wait_for_ready, timeout, metadata)

    @staticmethod
    def NextLockID(request, target, options=(), channel_credentials=None, call_credentials=None, insecure=False, compression=None, wait_for_ready=None, timeout=None, metadata=None):
        return grpc.experimental.unary_unary(request, target, '/osmosis.lockup.Query/NextLockID', osmosis_dot_lockup_dot_query__pb2.NextLockIDRequest.SerializeToString, osmosis_dot_lockup_dot_query__pb2.NextLockIDResponse.FromString, options, channel_credentials, insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    @staticmethod
    def SyntheticLockupByLockupID(request, target, options=(), channel_credentials=None, call_credentials=None, insecure=False, compression=None, wait_for_ready=None, timeout=None, metadata=None):
        return grpc.experimental.unary_unary(request, target, '/osmosis.lockup.Query/SyntheticLockupByLockupID', osmosis_dot_lockup_dot_query__pb2.SyntheticLockupByLockupIDRequest.SerializeToString, osmosis_dot_lockup_dot_query__pb2.SyntheticLockupByLockupIDResponse.FromString, options, channel_credentials, insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def Params(request, target, options=(), channel_credentials=None, call_credentials=None, insecure=False, compression=None, wait_for_ready=None, timeout=None, metadata=None):
        return grpc.experimental.unary_unary(request, target, '/osmosis.lockup.Query/Params', osmosis_dot_lockup_dot_query__pb2.QueryParamsRequest.SerializeToString, osmosis_dot_lockup_dot_query__pb2.QueryParamsResponse.FromString, options, channel_credentials, insecure, call_credentials, compression, wait_for_ready, timeout, metadata)