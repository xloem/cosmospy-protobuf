...
class QueryStub(object):
    ...
    def __init__(self, channel):
        ...
        self.UserConcentratedSuperfluidPositionsDelegated = channel.unary_unary('/osmosis.superfluid.Query/UserConcentratedSuperfluidPositionsDelegated', request_serializer=osmosis_dot_superfluid_dot_query__pb2.UserConcentratedSuperfluidPositionsDelegatedRequest.SerializeToString, response_deserializer=osmosis_dot_superfluid_dot_query__pb2.UserConcentratedSuperfluidPositionsDelegatedResponse.FromString)
        self.UserConcentratedSuperfluidPositionsUndelegating = channel.unary_unary('/osmosis.superfluid.Query/UserConcentratedSuperfluidPositionsUndelegating', request_serializer=osmosis_dot_superfluid_dot_query__pb2.UserConcentratedSuperfluidPositionsUndelegatingRequest.SerializeToString, response_deserializer=osmosis_dot_superfluid_dot_query__pb2.UserConcentratedSuperfluidPositionsUndelegatingResponse.FromString)
...
class QueryServicer(object):
    ...
    def UserConcentratedSuperfluidPositionsDelegated(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')

    def UserConcentratedSuperfluidPositionsUndelegating(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
class Query(object):
    ...
    @staticmethod
    def UserConcentratedSuperfluidPositionsDelegated(request, target, options=(), channel_credentials=None, call_credentials=None, insecure=False, compression=None, wait_for_ready=None, timeout=None, metadata=None):
        return grpc.experimental.unary_unary(request, target, '/osmosis.superfluid.Query/UserConcentratedSuperfluidPositionsDelegated', osmosis_dot_superfluid_dot_query__pb2.UserConcentratedSuperfluidPositionsDelegatedRequest.SerializeToString, osmosis_dot_superfluid_dot_query__pb2.UserConcentratedSuperfluidPositionsDelegatedResponse.FromString, options, channel_credentials, insecure, call_credentials, compression, wait_for_ready, timeout, metadata)

    @staticmethod
    def UserConcentratedSuperfluidPositionsUndelegating(request, target, options=(), channel_credentials=None, call_credentials=None, insecure=False, compression=None, wait_for_ready=None, timeout=None, metadata=None):
        return grpc.experimental.unary_unary(request, target, '/osmosis.superfluid.Query/UserConcentratedSuperfluidPositionsUndelegating', osmosis_dot_superfluid_dot_query__pb2.UserConcentratedSuperfluidPositionsUndelegatingRequest.SerializeToString, osmosis_dot_superfluid_dot_query__pb2.UserConcentratedSuperfluidPositionsUndelegatingResponse.FromString, options, channel_credentials, insecure, call_credentials, compression, wait_for_ready, timeout, metadata)