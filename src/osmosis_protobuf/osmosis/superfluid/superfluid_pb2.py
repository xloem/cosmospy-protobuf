...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _globals['_SUPERFLUIDASSETTYPE']._serialized_start = 947
    _globals['_SUPERFLUIDASSETTYPE']._serialized_end = 1037
    _globals['_SUPERFLUIDASSET']._serialized_start = 178
    _globals['_SUPERFLUIDASSET']._serialized_end = 281
    _globals['_SUPERFLUIDINTERMEDIARYACCOUNT']._serialized_start = 283
    _globals['_SUPERFLUIDINTERMEDIARYACCOUNT']._serialized_end = 365
    _globals['_OSMOEQUIVALENTMULTIPLIERRECORD']._serialized_start = 368
    _globals['_OSMOEQUIVALENTMULTIPLIERRECORD']._serialized_end = 526
    _globals['_SUPERFLUIDDELEGATIONRECORD']._serialized_start = 529
    _globals['_SUPERFLUIDDELEGATIONRECORD']._serialized_end = 820
    _globals['_LOCKIDINTERMEDIARYACCOUNTCONNECTION']._serialized_start = 822
    _globals['_LOCKIDINTERMEDIARYACCOUNTCONNECTION']._serialized_end = 906
    _globals['_UNPOOLWHITELISTEDPOOLS']._serialized_start = 908
    _globals['_UNPOOLWHITELISTEDPOOLS']._serialized_end = 945