...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _globals['_MSGCREATEGAUGE']._serialized_start = 198
    _globals['_MSGCREATEGAUGE']._serialized_end = 530
    _globals['_MSGCREATEGAUGERESPONSE']._serialized_start = 532
    _globals['_MSGCREATEGAUGERESPONSE']._serialized_end = 556
    _globals['_MSGADDTOGAUGE']._serialized_start = 559
    _globals['_MSGADDTOGAUGE']._serialized_end = 719
    _globals['_MSGADDTOGAUGERESPONSE']._serialized_start = 721
    _globals['_MSGADDTOGAUGERESPONSE']._serialized_end = 744
    _globals['_MSG']._serialized_start = 747
