...
class QueryBase(abc.ABC):
    ...
    @abc.abstractmethod
    async def ModuleDistributedCoins(self, stream: 'grpclib.server.Stream[osmosis.incentives.query_pb2.ModuleDistributedCoinsRequest, osmosis.incentives.query_pb2.ModuleDistributedCoinsResponse]') -> None:
        pass
...
class QueryStub:
    ...
    def __init__(self, channel: grpclib.client.Channel) -> None:
        ...
        self.ModuleDistributedCoins = grpclib.client.UnaryUnaryMethod(channel, '/osmosis.incentives.Query/ModuleDistributedCoins', osmosis.incentives.query_pb2.ModuleDistributedCoinsRequest, osmosis.incentives.query_pb2.ModuleDistributedCoinsResponse)
