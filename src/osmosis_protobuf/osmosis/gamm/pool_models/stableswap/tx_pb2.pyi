...
class MsgCreateStableswapPool(_message.Message):
    __slots__ = ['sender', 'poolParams', 'initial_pool_liquidity', 'future_pool_governor']
    ...
    sender: str
    poolParams: _stableswap_pool_pb2.PoolParams
    initial_pool_liquidity: _containers.RepeatedCompositeFieldContainer[_coin_pb2.Coin]
    future_pool_governor: str

    def __init__(self, sender: _Optional[str]=..., poolParams: _Optional[_Union[_stableswap_pool_pb2.PoolParams, _Mapping]]=..., initial_pool_liquidity: _Optional[_Iterable[_Union[_coin_pb2.Coin, _Mapping]]]=..., future_pool_governor: _Optional[str]=...) -> None:
        ...
