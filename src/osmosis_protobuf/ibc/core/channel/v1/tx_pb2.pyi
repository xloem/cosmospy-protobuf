...
class ResponseResultType(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    __slots__ = []
    RESPONSE_RESULT_UNSPECIFIED: _ClassVar[ResponseResultType]
    RESPONSE_RESULT_NOOP: _ClassVar[ResponseResultType]
    RESPONSE_RESULT_SUCCESS: _ClassVar[ResponseResultType]
