...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _globals['_CONSENSUSSTATEWITHHEIGHT']._serialized_end = 430
    _globals['_CLIENTCONSENSUSSTATES']._serialized_start = 433
    _globals['_CLIENTCONSENSUSSTATES']._serialized_end = 602
    _globals['_CLIENTUPDATEPROPOSAL']._serialized_start = 605
    _globals['_CLIENTUPDATEPROPOSAL']._serialized_end = 789
    _globals['_UPGRADEPROPOSAL']._serialized_start = 792
    _globals['_UPGRADEPROPOSAL']._serialized_end = 996
    _globals['_HEIGHT']._serialized_start = 998
    _globals['_HEIGHT']._serialized_end = 1122
    _globals['_PARAMS']._serialized_start = 1124
    _globals['_PARAMS']._serialized_end = 1185