...
class Params(_message.Message):
    __slots__ = ['enabled', 'blocks_per_distribution_transmission', 'distribution_transmission_channel', 'provider_fee_pool_addr_str', 'ccv_timeout_period', 'transfer_timeout_period', 'consumer_redistribution_fraction', 'historical_entries', 'unbonding_period']
