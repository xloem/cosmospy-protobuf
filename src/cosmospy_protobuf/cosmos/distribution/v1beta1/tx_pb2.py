...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _globals['_MSGFUNDCOMMUNITYPOOL']._serialized_start = 641
    _globals['_MSGFUNDCOMMUNITYPOOL']._serialized_end = 785
    _globals['_MSGFUNDCOMMUNITYPOOLRESPONSE']._serialized_start = 787
    _globals['_MSGFUNDCOMMUNITYPOOLRESPONSE']._serialized_end = 817
    _globals['_MSG']._serialized_start = 820
