...
class QueryStub:
    ...
    def __init__(self, channel: grpclib.client.Channel) -> None:
        ...
        self.TokenizeShareRecordReward = grpclib.client.UnaryUnaryMethod(channel, '/cosmos.distribution.v1beta1.Query/TokenizeShareRecordReward', cosmos.distribution.v1beta1.query_pb2.QueryTokenizeShareRecordRewardRequest, cosmos.distribution.v1beta1.query_pb2.QueryTokenizeShareRecordRewardResponse)