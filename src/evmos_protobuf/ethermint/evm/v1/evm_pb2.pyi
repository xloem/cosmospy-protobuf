...
class Params(_message.Message):
    __slots__ = ['evm_denom', 'enable_create', 'enable_call', 'extra_eips', 'chain_config', 'allow_unprotected_txs', 'active_precompiles']
    ...
    ACTIVE_PRECOMPILES_FIELD_NUMBER: _ClassVar[int]
    evm_denom: str
    enable_create: bool
    enable_call: bool
    ...
    active_precompiles: _containers.RepeatedScalarFieldContainer[str]

    def __init__(self, evm_denom: _Optional[str]=..., enable_create: bool=..., enable_call: bool=..., extra_eips: _Optional[_Iterable[int]]=..., chain_config: _Optional[_Union[ChainConfig, _Mapping]]=..., allow_unprotected_txs: bool=..., active_precompiles: _Optional[_Iterable[str]]=...) -> None:
        ...
