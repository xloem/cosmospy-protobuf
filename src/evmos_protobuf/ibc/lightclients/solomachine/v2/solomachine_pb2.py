...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    DESCRIPTOR._serialized_options = b'ZFgithub.com/cosmos/ibc-go/v6/modules/light-clients/06-solomachine/types'
