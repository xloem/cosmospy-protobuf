...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    DESCRIPTOR._serialized_options = b'ZDgithub.com/cosmos/ibc-go/v6/modules/light-clients/09-localhost/types'
