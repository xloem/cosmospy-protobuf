...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _QUERY.methods_by_name['ConnectionParams']._serialized_options = b'\x82\xd3\xe4\x93\x02 \x12\x1e/ibc/core/connection/v1/params'
