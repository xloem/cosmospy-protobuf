...
class QueryStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ConnectionParams = channel.unary_unary('/ibc.core.connection.v1.Query/ConnectionParams', request_serializer=ibc_dot_core_dot_connection_dot_v1_dot_query__pb2.QueryConnectionParamsRequest.SerializeToString, response_deserializer=ibc_dot_core_dot_connection_dot_v1_dot_query__pb2.QueryConnectionParamsResponse.FromString)
...
class Query(object):
    ...
    @staticmethod
    def ConnectionParams(request, target, options=(), channel_credentials=None, call_credentials=None, insecure=False, compression=None, wait_for_ready=None, timeout=None, metadata=None):
        return grpc.experimental.unary_unary(request, target, '/ibc.core.connection.v1.Query/ConnectionParams', ibc_dot_core_dot_connection_dot_v1_dot_query__pb2.QueryConnectionParamsRequest.SerializeToString, ibc_dot_core_dot_connection_dot_v1_dot_query__pb2.QueryConnectionParamsResponse.FromString, options, channel_credentials, insecure, call_credentials, compression, wait_for_ready, timeout, metadata)