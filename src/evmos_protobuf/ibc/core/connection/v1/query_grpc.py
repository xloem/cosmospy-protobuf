...
class QueryStub:
    ...
    def __init__(self, channel: grpclib.client.Channel) -> None:
        ...
        self.ConnectionParams = grpclib.client.UnaryUnaryMethod(channel, '/ibc.core.connection.v1.Query/ConnectionParams', ibc.core.connection.v1.query_pb2.QueryConnectionParamsRequest, ibc.core.connection.v1.query_pb2.QueryConnectionParamsResponse)