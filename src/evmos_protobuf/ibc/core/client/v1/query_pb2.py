...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _QUERY.methods_by_name['ClientParams']._serialized_options = b'\x82\xd3\xe4\x93\x02\x1c\x12\x1a/ibc/core/client/v1/params'
