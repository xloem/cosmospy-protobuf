...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _QUERYDENOMTRACESRESPONSE.fields_by_name['denom_traces']._serialized_options = b'\xc8\xde\x1f\x00\xaa\xdf\x1f\x06Traces'
