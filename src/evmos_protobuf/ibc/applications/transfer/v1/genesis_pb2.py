...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _GENESISSTATE.fields_by_name['denom_traces']._serialized_options = b'\xc8\xde\x1f\x00\xf2\xde\x1f\x13yaml:"denom_traces"\xaa\xdf\x1f\x06Traces'
