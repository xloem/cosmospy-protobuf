...
class Allocation(_message.Message):
    __slots__ = ['source_port', 'source_channel', 'spend_limit', 'allow_list']
    ...
    def __init__(self, source_port: _Optional[str]=..., source_channel: _Optional[str]=..., spend_limit: _Optional[_Iterable[_Union[_coin_pb2.Coin, _Mapping]]]=..., allow_list: _Optional[_Iterable[str]]=...) -> None:
        ...
