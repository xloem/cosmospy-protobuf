...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _MSGCREATEVESTINGACCOUNT._serialized_options = b'\xe8\xa0\x1f\x01\x82\xe7\xb0*\x0cfrom_address'
    ...
    _MSGCREATEPERIODICVESTINGACCOUNT._serialized_options = b'\xe8\xa0\x1f\x00\x82\xe7\xb0*\x0cfrom_address'
    _globals['_MSGCREATEVESTINGACCOUNT']._serialized_start = 204
    _globals['_MSGCREATEVESTINGACCOUNT']._serialized_end = 474
    _globals['_MSGCREATEVESTINGACCOUNTRESPONSE']._serialized_start = 476
    _globals['_MSGCREATEVESTINGACCOUNTRESPONSE']._serialized_end = 509
    _globals['_MSGCREATEPERMANENTLOCKEDACCOUNT']._serialized_start = 512
    _globals['_MSGCREATEPERMANENTLOCKEDACCOUNT']._serialized_end = 734
    _globals['_MSGCREATEPERMANENTLOCKEDACCOUNTRESPONSE']._serialized_start = 736
    _globals['_MSGCREATEPERMANENTLOCKEDACCOUNTRESPONSE']._serialized_end = 777
    _globals['_MSGCREATEPERIODICVESTINGACCOUNT']._serialized_start = 780
    _globals['_MSGCREATEPERIODICVESTINGACCOUNT']._serialized_end = 961
    _globals['_MSGCREATEPERIODICVESTINGACCOUNTRESPONSE']._serialized_start = 963
    _globals['_MSGCREATEPERIODICVESTINGACCOUNTRESPONSE']._serialized_end = 1004
    _globals['_MSG']._serialized_start = 1007
    _globals['_MSG']._serialized_end = 1453